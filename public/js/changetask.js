    ...
    $("#addbtn").click(function(){
        if(x < 10){
            $("#addinput").append('<div class="flex items-center gap-x-2">' +
                ...
                ' type="search" name="location'+ x +'" placeholder="Shahar, ko\'cha, uy" aria-label="Full name"> ' +
                ...
                '<svg class="h-4 w-4 text-purple-500" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">'+
