        ...
        <div class="flex lg:flex-row flex-col justify-center mt-6">
            ...
            <div class="lg:w-4/5 w-full text-base lg:mt-0 mt-4">
                    <div class="">
                        ...
                        {!! App\Services\CustomService::getContentText('security', 'security_1') !!}
                    </div>
                    <div class="flex lg:flex-row flex-col mt-4  mx-auto">
                        <div class="lg:w-1/2 w-full lg:block hidden">
                            <img class="w-96 h-60 mt-16" src="{{ App\Services\CustomService::getContentImage('security', 'security_2') }}" alt="">
                        </div>
                        <div class="lg:w-1/2 w-full text-left ml-4 mt-4 lg:block hidden w-4/5">
                            {!! App\Services\CustomService::getContentText('security', 'security_2') !!}
                        </div>
                        ...
                        <div class="lg:w-1/2 w-full lg:hidden block">
                            <img class="w-76 h-64 mx-auto" src="{{ App\Services\CustomService::getContentImage('security', 'security_2') }}" alt="">
                        </div>
                    </div>
                    <div class="w-full mt-10">
                        <div>
                            {!! App\Services\CustomService::getContentText('security', 'security_3') !!}
                        </div>
