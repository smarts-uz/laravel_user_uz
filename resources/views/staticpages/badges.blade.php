        ...
        <div class="flex lg:flex-row flex-col justify-center mt-6">
            ...
            <div class="lg:w-4/5 w-full text-base lg:mt-0 mt-4">
                <div class="w-full">
                    ...
                    <p class="mt-5"><span class="text-blue-600">{{__('Рейтинг исполнителей')}}.</span> {{__(' считается в каждой категории отдельно и обновляется раз в сутки. От него зависит, на каком месте окажется отклик исполнителя в откликах на задание. Чем выше рейтинг в категории, тем выше размещается отклик и тем больше шансов получить задание.')}}</p>
