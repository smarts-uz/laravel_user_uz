...
<div id="mobile_bar" class="w-full hidden">
        ...
        <div class=" w-11/12 mx-auto ">
            <div class="w-full relative">
                ...
                <div
                    ...
                    <svg class="h-4 w-4 text-purple-500 mt-1" id="geobut2" width="12" height="12" viewBox="0 0 24 24"
    ...
    <div class="w-11/12 mx-auto">
        <label class="block w-full border-b pb-4 items-center mt-3">
            <input type="checkbox" id="remJob2" class="form-checkbox checkboxByAs mr-4  h-5 w-5 text-orange-400"><span
                class="sm:ml-2 ml-0.5 text-gray-700 lg:text-sm">{{__('Удалённая работа')}}</span>
        </label>
        <label class="block w-full border-b pb-4 items-center mt-3">
            <input type="checkbox" id="noResp2" class="form-checkbox mr-4  h-5 w-5 text-orange-400"><span
