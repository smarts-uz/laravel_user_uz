        ...
        $("#addbtn").click(function(){
            if(x < 10){
                ...
                $("#addinput").append('<div class="flex items-center gap-x-2">' +
                    ...
                    ' <input oninput="myMapFunction()" id="suggest'+(x)+'" class="appearance-none bg-transparent w-full text-gray-700    py-1 px-2 leading-tight focus:outline-none"' +
                    ' type="search" name="location'+ x +'" placeholder="{{__('Город, Улица, Дом')}}" aria-label="Full name"> ' +
                    ...
                    '<svg class="h-4 w-4 text-yellow-500" width="18" height="18" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">'+
