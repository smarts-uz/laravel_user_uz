...
@section('content')
    <div class="mt-3 text-center text-base">
        ...
        <div class="mx-auto my-8">
            <ul id="tabs" class="nav nav-tabs flex  text-center flex-wrap list-none border-b-0 pl-0 mb-2 justify-center">
                <li class="bg-white text-xl px-12 text-gray-800 font-semibold hover:bg-gray-200 py-2 text-yellow-500 border-b-2 border-yellow-500"><a id="default-tab" href="#first">ЭЛ. ПОЧТА</a></li>
                <li class="px-12 text-xl text-gray-800 hover:bg-gray-200 font-semibold py-2"><a href="#second">СМС</a></li>
            </ul>
        </div>
        ...
        <div id="tab-contents" class="flex justify-center">
            <div id="first" class="p-2">
                <div class="mx-auto flex items-center justify-center w-full">
                    <p class="mb-4">
                        Укажите почту, привязанную к вашей <br> учетной записи. Мы отправим письмо <br> для восстановления пароля.
                    </p>
                </div>
                <div class="mb-4">
                ...
                <button type="button" class="w-80 h-12 rounded-lg bg-green-500 text-gray-200 uppercase   font-semibold hover:bg-green-500 text-gray-100 transition mb-4">
                    {{__('Отправить')}}
                </button>
            </div>
